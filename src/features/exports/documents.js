...
(function(){
  ...
  function installAccountHook(){if(typeof window._renderAccountPage==='function'&&!window._renderAccountPage.__rtDocs){var base=window._renderAccountPage,wrap=function(account){if(account&&account.id!=null)activeAccountId=account.id;var out=base.apply(this,arguments);accountAction();return out;};wrap.__rtDocs=true;window._renderAccountPage=wrap;}}
